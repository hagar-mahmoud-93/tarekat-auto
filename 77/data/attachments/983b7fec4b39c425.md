...
Call log:
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    506 × waiting for element to be visible, enabled and stable
        - element is not enabled
      - retrying click action
        - waiting 500ms
...
- generic [ref=e1]:
  ...
  - generic [ref=e2]:
    ...
    - list [ref=e8]:
      - listitem [ref=e9]: "Inheritance case seeded successfully. Inheritance ID: f5fc88c1-dd85-4a64-8bb7-002b39a4517d | Heirs: 2 | Auth User IDs: [4231, 4232] | Assets: 2"
    - generic [ref=e10]:
      - listitem [ref=e12]: "Inheritance case seeded successfully. Inheritance ID: f5fc88c1-dd85-4a64-8bb7-002b39a4517d | Heirs: 2 | Auth User IDs: [4231, 4232] | Assets: 2"
      - generic [ref=e13]:
        ...
        - table [ref=e15]:
          ...
          - rowgroup [ref=e22]:
            - row "عبدالرحمن العتيبي 1122363047 4231 Login as User" [ref=e23]:
              - cell "عبدالرحمن العتيبي" [ref=e24]
              - cell "1122363047" [ref=e25]
              - cell "4231" [ref=e26]
              - cell "Login as User" [ref=e27]:
                - link "Login as User" [ref=e28] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4231/
            - row "خديجة العتيبي 1199428594 4232 Login as User" [ref=e29]:
              - cell "خديجة العتيبي" [ref=e30]
              - cell "1199428594" [ref=e31]
              - cell "4232" [ref=e32]
              - cell "Login as User" [ref=e33]:
                - link "Login as User" [active] [ref=e34] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4232/
      - generic [ref=e35]:
        - generic [ref=e36]:
          - strong [ref=e37]: Extract Case as JSON
          - link "⇩ Download JSON" [ref=e38] [cursor=pointer]:
            - /url: /admin/inheritance_seeder/inheritanceseeder/extract-json/f5fc88c1-dd85-4a64-8bb7-002b39a4517d/?download=1
          - button "Copy" [ref=e39] [cursor=pointer]
        - generic [ref=e40]: "{ \"_name\": \"seed-1824515071\", \"deceased\": { \"identityNumber\": \"1824515071\", \"identityType\": 1, \"firstName\": \"زينب\", \"middleName\": \"خالد\", \"lastName\": \"علي\", \"familyName\": \"العتيبي\", \"fullName\": \"زينب خالد علي العتيبي\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1975-11-19T00:00:00\", \"birthDateHijri\": \"1395/11/16\", \"deathDate\": \"2026-05-04T00:00:00\", \"deathDateHijri\": \"1447/11/17\", \"deathDocumentIssueDate\": null, \"deathDocumentIssueDateHijri\": \"\" }, \"beneficiary\": { \"identityNumber\": \"1122363047\", \"identityType\": 1, \"firstName\": \"عبدالرحمن\", \"middleName\": null, \"lastName\": null, \"familyName\": \"العتيبي\", \"fullName\": \"عبدالرحمن العتيبي\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"1990-01-01T00:00:00\", \"birthDateHijri\": \"1410/06/04\", \"phoneNumber\": \"0594185570\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"beneficiaryTypeId\": 1, \"agencyTypeId\": null }, \"heirs\": [ { \"id\": \"d5bdbc4e-fb6a-4729-a4eb-e558132d0ab7\", \"identityNumber\": \"1199428594\", \"identityType\": 1, \"firstName\": \"خديجة\", \"middleName\": null, \"lastName\": null, \"familyName\": \"العتيبي\", \"fullName\": \"خديجة العتيبي\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1999-01-26T00:00:00\", \"birthDateHijri\": \"1419/10/09\", \"phoneNumber\": \"0520451888\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"isMinor\": false, \"isAdult\": true, \"isDead\": false, \"isWifePregnant\": null } ], \"request\": { \"id\": 2217, \"requestNumber\": \"SEED-f5fc88c1\" }, \"estateAssets\": { \"bankAccounts\": [ { \"iban\": \"SA0373408970277095938815\", \"accountNumber\": \"ACC71411706\", \"balance\": \"50000.00\" } ], \"investments\": [ { \"accountNumber\": \"ACC88408534\", \"balance\": \"25000.00\" } ] } }"
      - generic [ref=e41]:
