...
```yaml
- generic [ref=e1]:
  - text: ops-alibaba server (v0.0.3784)
  - generic [ref=e2]:
    - text: 
    - list [ref=e3]:
    ...
    - list [ref=e8]:
      - listitem [ref=e9]: "Inheritance case seeded successfully. Inheritance ID: 53fc3bf3-7637-4f5f-8ac9-749c70e37c7f | Heirs: 2 | Auth User IDs: [4199, 4200] | Assets: 2"
    - generic [ref=e10]:
      - listitem [ref=e12]: "Inheritance case seeded successfully. Inheritance ID: 53fc3bf3-7637-4f5f-8ac9-749c70e37c7f | Heirs: 2 | Auth User IDs: [4199, 4200] | Assets: 2"
      - generic [ref=e13]:
        ...
        - table [ref=e15]:
          ...
          - rowgroup [ref=e22]:
            - row "يوسف العتيبي 1032466579 4199 Login as User" [ref=e23]:
              - cell "يوسف العتيبي" [ref=e24]
              - cell "1032466579" [ref=e25]
              - cell "4199" [ref=e26]
              - cell "Login as User" [ref=e27]:
                - link "Login as User" [active] [ref=e28] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4199/
            - row "إبراهيم العتيبي 1590464110 4200 Login as User" [ref=e29]:
              - cell "إبراهيم العتيبي" [ref=e30]
              - cell "1590464110" [ref=e31]
              - cell "4200" [ref=e32]
              - cell "Login as User" [ref=e33]:
                - link "Login as User" [ref=e34] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4200/
      - generic [ref=e35]:
        - generic [ref=e36]:
          - strong [ref=e37]: Extract Case as JSON
          - link "⇩ Download JSON" [ref=e38] [cursor=pointer]:
            - /url: /admin/inheritance_seeder/inheritanceseeder/extract-json/53fc3bf3-7637-4f5f-8ac9-749c70e37c7f/?download=1
          - button "Copy" [ref=e39] [cursor=pointer]
        - generic [ref=e40]: "{ \"_name\": \"seed-1214957523\", \"deceased\": { \"identityNumber\": \"1214957523\", \"identityType\": 1, \"firstName\": \"لينا\", \"middleName\": \"أحمد\", \"lastName\": \"محمد\", \"familyName\": \"العتيبي\", \"fullName\": \"لينا أحمد محمد العتيبي\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1975-09-05T00:00:00\", \"birthDateHijri\": \"1395/08/29\", \"deathDate\": \"2026-05-13T00:00:00\", \"deathDateHijri\": \"1447/11/26\", \"deathDocumentIssueDate\": null, \"deathDocumentIssueDateHijri\": \"\" }, \"beneficiary\": { \"identityNumber\": \"1032466579\", \"identityType\": 1, \"firstName\": \"يوسف\", \"middleName\": null, \"lastName\": null, \"familyName\": \"العتيبي\", \"fullName\": \"يوسف العتيبي\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"1990-01-01T00:00:00\", \"birthDateHijri\": \"1410/06/04\", \"phoneNumber\": \"0533561481\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"beneficiaryTypeId\": 1, \"agencyTypeId\": null }, \"heirs\": [ { \"id\": \"dae50009-887c-409b-b1f4-a2ef3fcbca03\", \"identityNumber\": \"1590464110\", \"identityType\": 1, \"firstName\": \"إبراهيم\", \"middleName\": null, \"lastName\": null, \"familyName\": \"العتيبي\", \"fullName\": \"إبراهيم العتيبي\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"2007-10-29T00:00:00\", \"birthDateHijri\": \"1428/10/17\", \"phoneNumber\": \"0501180737\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"isMinor\": false, \"isAdult\": true, \"isDead\": false, \"isWifePregnant\": null } ], \"request\": { \"id\": 2201, \"requestNumber\": \"SEED-53fc3bf3\" }, \"estateAssets\": { \"bankAccounts\": [ { \"iban\": \"SA2210319968544603342027\", \"accountNumber\": \"ACC29509651\", \"balance\": \"500000.00\" } ], \"investments\": [ { \"accountNumber\": \"ACC94775710\", \"balance\": \"200000.00\" } ] } }"
      - generic [ref=e41]:
