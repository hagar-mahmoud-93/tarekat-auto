...
Call log:
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    528 × waiting for element to be visible, enabled and stable
        - element is not enabled
      - retrying click action
        - waiting 500ms
...
- generic [ref=e1]:
  ...
  - generic [ref=e2]:
    ...
    - list [ref=e8]:
      - listitem [ref=e9]: "Inheritance case seeded successfully. Inheritance ID: 51fef97f-3dd2-48f8-a256-0575a5038a1a | Heirs: 2 | Auth User IDs: [4831, 4832] | Assets: 2"
    - generic [ref=e10]:
      - listitem [ref=e12]: "Inheritance case seeded successfully. Inheritance ID: 51fef97f-3dd2-48f8-a256-0575a5038a1a | Heirs: 2 | Auth User IDs: [4831, 4832] | Assets: 2"
      - generic [ref=e13]:
        ...
        - table [ref=e15]:
          ...
          - rowgroup [ref=e22]:
            - row "إبراهيم الشهري 1965637271 4831 Login as User" [ref=e23]:
              - cell "إبراهيم الشهري" [ref=e24]
              - cell "1965637271" [ref=e25]
              - cell "4831" [ref=e26]
              - cell "Login as User" [ref=e27]:
                - link "Login as User" [active] [ref=e28] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4831/
            - row "سعد الشهري 1308759322 4832 Login as User" [ref=e29]:
              - cell "سعد الشهري" [ref=e30]
              - cell "1308759322" [ref=e31]
              - cell "4832" [ref=e32]
              - cell "Login as User" [ref=e33]:
                - link "Login as User" [ref=e34] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4832/
      - generic [ref=e35]:
        - generic [ref=e36]:
          - strong [ref=e37]: Extract Case as JSON
          - link "⇩ Download JSON" [ref=e38] [cursor=pointer]:
            - /url: /admin/inheritance_seeder/inheritanceseeder/extract-json/51fef97f-3dd2-48f8-a256-0575a5038a1a/?download=1
          - button "Copy" [ref=e39] [cursor=pointer]
        - generic [ref=e40]: "{ \"_name\": \"seed-1036178381\", \"deceased\": { \"identityNumber\": \"1036178381\", \"identityType\": 1, \"firstName\": \"سعد\", \"middleName\": \"علي\", \"lastName\": \"عبدالعزيز\", \"familyName\": \"الشهري\", \"fullName\": \"سعد علي عبدالعزيز الشهري\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"1965-06-19T00:00:00\", \"birthDateHijri\": \"1385/02/20\", \"deathDate\": \"2026-03-28T00:00:00\", \"deathDateHijri\": \"1447/10/09\", \"deathDocumentIssueDate\": null, \"deathDocumentIssueDateHijri\": \"\" }, \"beneficiary\": { \"identityNumber\": \"1965637271\", \"identityType\": 1, \"firstName\": \"إبراهيم\", \"middleName\": null, \"lastName\": null, \"familyName\": \"الشهري\", \"fullName\": \"إبراهيم الشهري\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"1990-01-01T00:00:00\", \"birthDateHijri\": \"1410/06/04\", \"phoneNumber\": \"0526303688\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"beneficiaryTypeId\": 1, \"agencyTypeId\": null }, \"heirs\": [ { \"id\": \"9f9c0577-4909-4490-897d-88d916878fc6\", \"identityNumber\": \"1308759322\", \"identityType\": 1, \"firstName\": \"سعد\", \"middleName\": null, \"lastName\": null, \"familyName\": \"الشهري\", \"fullName\": \"سعد الشهري\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"2008-08-13T00:00:00\", \"birthDateHijri\": \"1429/08/12\", \"phoneNumber\": \"0592420666\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"isMinor\": false, \"isAdult\": true, \"isDead\": false, \"isWifePregnant\": null } ], \"request\": { \"id\": 2542, \"requestNumber\": \"SEED-51fef97f\" }, \"estateAssets\": { \"bankAccounts\": [ { \"iban\": \"SA6743766696152387914632\", \"accountNumber\": \"ACC15271890\", \"balance\": \"50000.00\" } ], \"investments\": [ { \"accountNumber\": \"ACC42615869\", \"balance\": \"25000.00\" } ] } }"
      - generic [ref=e41]:
