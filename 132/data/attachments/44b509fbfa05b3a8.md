...
- region "المحافظ الاستثمارية":
  - button "رقم المحفظة الاستثمارية:PORT6272782883" [expanded]:
    - paragraph: رقم المحفظة الاستثمارية:PORT6272782883
  - region "رقم المحفظة الاستثمارية:PORT6272782883":
    - img
    - paragraph: موبايلي
    - list:
    ...
    - table:
      ...
      - rowgroup:
        - row "لينا عمر علي البقمي %50.00 1/2 ابن 250 أسهم":
          - cell "لينا عمر علي البقمي":
            - paragraph: لينا عمر علي البقمي
          - cell "%50.00 1/2"
          - cell "ابن"
          - cell "250 أسهم"
