...
- text: 02:11 pm
- img
- text: نورة عبدالله أحمد العتيبي
- img
- text: خروج
- img
...
- region "المحافظ الاستثمارية":
  - button "رقم المحفظة الاستثمارية:PORT5772099731" [expanded]:
    - paragraph: رقم المحفظة الاستثمارية:PORT5772099731
  - region "رقم المحفظة الاستثمارية:PORT5772099731":
    - img
    ...
    - table:
      ...
      - rowgroup:
        - row "نورة عبدالله أحمد العتيبي %50.00 1/2 ابن 500 أسهم":
          - cell "نورة عبدالله أحمد العتيبي":
            - paragraph: نورة عبدالله أحمد العتيبي
          - cell "%50.00 1/2"
          - cell "ابن"
          - cell "500 أسهم"
