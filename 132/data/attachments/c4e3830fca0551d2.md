...
- region "المحافظ الاستثمارية":
  - button "رقم المحفظة الاستثمارية:PORT1886252027" [expanded]:
    - paragraph: رقم المحفظة الاستثمارية:PORT1886252027
  - region "رقم المحفظة الاستثمارية:PORT1886252027":
    - img
    - paragraph: البنك السعودي الأول
    - list:
      - listitem: وسيط التداول QA Seeder Broker
      - listitem: عدد الأسهم الكلي القابل للقسمة 100 أسهم
      - listitem: محلي نعم
      - listitem: عدد الأسهم الكلي 100 أسهم
    - table:
      - rowgroup:
      ...
      - rowgroup:
        - row "زينب محمد سعد القحطاني %50.00 1/2 ابن 50 أسهم":
          - cell "زينب محمد سعد القحطاني":
            - paragraph: زينب محمد سعد القحطاني
          - cell "%50.00 1/2"
          - cell "ابن"
          - cell "50 أسهم"
...
- table:
  ...
  - rowgroup:
    - row "QA Seeder Broker المحافظ 100أسهم 0أسهم":
      - cell "QA Seeder Broker"
      - cell "المحافظ"
      - cell "100أسهم"
      - cell "0أسهم"
- textbox "رقم الجوال": "0515080976"
- text: رقم الجوال
