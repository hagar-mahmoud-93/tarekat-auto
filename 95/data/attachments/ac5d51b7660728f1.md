...
- generic [ref=e1]:
  ...
  - generic [ref=e2]:
    ...
    - list [ref=e8]:
      - listitem [ref=e9]: "Inheritance case seeded successfully. Inheritance ID: e431b87b-533f-4477-91da-50c9df1e2115 | Heirs: 2 | Auth User IDs: [4619, 4620] | Assets: 2"
    - generic [ref=e10]:
      - listitem [ref=e12]: "Inheritance case seeded successfully. Inheritance ID: e431b87b-533f-4477-91da-50c9df1e2115 | Heirs: 2 | Auth User IDs: [4619, 4620] | Assets: 2"
      - generic [ref=e13]:
        ...
        - table [ref=e15]:
          ...
          - rowgroup [ref=e22]:
            - row "عائشة العمري 1505364246 4619 Login as User" [ref=e23]:
              - cell "عائشة العمري" [ref=e24]
              - cell "1505364246" [ref=e25]
              - cell "4619" [ref=e26]
              - cell "Login as User" [ref=e27]:
                - link "Login as User" [active] [ref=e28] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4619/
            - row "أحمد العمري 1992362899 4620 Login as User" [ref=e29]:
              - cell "أحمد العمري" [ref=e30]
              - cell "1992362899" [ref=e31]
              - cell "4620" [ref=e32]
              - cell "Login as User" [ref=e33]:
                - link "Login as User" [ref=e34] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4620/
      - generic [ref=e35]:
        - generic [ref=e36]:
          - strong [ref=e37]: Extract Case as JSON
          - link "⇩ Download JSON" [ref=e38] [cursor=pointer]:
            - /url: /admin/inheritance_seeder/inheritanceseeder/extract-json/e431b87b-533f-4477-91da-50c9df1e2115/?download=1
          - button "Copy" [ref=e39] [cursor=pointer]
        - generic [ref=e40]: "{ \"_name\": \"seed-1875180112\", \"deceased\": { \"identityNumber\": \"1875180112\", \"identityType\": 1, \"firstName\": \"هند\", \"middleName\": \"عمر\", \"lastName\": \"علي\", \"familyName\": \"العمري\", \"fullName\": \"هند عمر علي العمري\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1971-12-08T00:00:00\", \"birthDateHijri\": \"1391/10/20\", \"deathDate\": \"2026-02-04T00:00:00\", \"deathDateHijri\": \"1447/08/16\", \"deathDocumentIssueDate\": null, \"deathDocumentIssueDateHijri\": \"\" }, \"beneficiary\": { \"identityNumber\": \"1505364246\", \"identityType\": 1, \"firstName\": \"عائشة\", \"middleName\": null, \"lastName\": null, \"familyName\": \"العمري\", \"fullName\": \"عائشة العمري\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1990-01-01T00:00:00\", \"birthDateHijri\": \"1410/06/04\", \"phoneNumber\": \"0550966071\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"beneficiaryTypeId\": 1, \"agencyTypeId\": null }, \"heirs\": [ { \"id\": \"46a9c5ec-b448-4089-b4c4-eaf41e8bc5e9\", \"identityNumber\": \"1992362899\", \"identityType\": 1, \"firstName\": \"أحمد\", \"middleName\": null, \"lastName\": null, \"familyName\": \"العمري\", \"fullName\": \"أحمد العمري\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"1999-06-25T00:00:00\", \"birthDateHijri\": \"1420/03/11\", \"phoneNumber\": \"0548373314\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"isMinor\": false, \"isAdult\": true, \"isDead\": false, \"isWifePregnant\": null } ], \"request\": { \"id\": 2411, \"requestNumber\": \"SEED-e431b87b\" }, \"estateAssets\": { \"bankAccounts\": [ { \"iban\": \"SA7312613827894510195982\", \"accountNumber\": \"ACC63149265\", \"balance\": \"25000.00\" } ], \"investments\": [ { \"accountNumber\": \"ACC01465294\", \"balance\": \"25000.00\" } ] } }"
      - generic [ref=e41]:
