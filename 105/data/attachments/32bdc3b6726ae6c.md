...
- generic [ref=e1]:
  ...
  - generic [ref=e2]:
    ...
    - list [ref=e8]:
      - listitem [ref=e9]: "Inheritance case seeded successfully. Inheritance ID: 89c7264c-126c-42bb-bc88-69b4cc94a4b2 | Heirs: 2 | Auth User IDs: [5033, 5034] | Assets: 2"
    - generic [ref=e10]:
      - listitem [ref=e12]: "Inheritance case seeded successfully. Inheritance ID: 89c7264c-126c-42bb-bc88-69b4cc94a4b2 | Heirs: 2 | Auth User IDs: [5033, 5034] | Assets: 2"
      - generic [ref=e13]:
        ...
        - table [ref=e15]:
          ...
          - rowgroup [ref=e22]:
            - row "عائشة البقمي 1652276595 5033 Login as User" [ref=e23]:
              - cell "عائشة البقمي" [ref=e24]
              - cell "1652276595" [ref=e25]
              - cell "5033" [ref=e26]
              - cell "Login as User" [ref=e27]:
                - link "Login as User" [active] [ref=e28] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/5033/
            - row "محمد البقمي 1144365332 5034 Login as User" [ref=e29]:
              - cell "محمد البقمي" [ref=e30]
              - cell "1144365332" [ref=e31]
              - cell "5034" [ref=e32]
              - cell "Login as User" [ref=e33]:
                - link "Login as User" [ref=e34] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/5034/
      - generic [ref=e35]:
        - generic [ref=e36]:
          - strong [ref=e37]: Extract Case as JSON
          - link "⇩ Download JSON" [ref=e38] [cursor=pointer]:
            - /url: /admin/inheritance_seeder/inheritanceseeder/extract-json/89c7264c-126c-42bb-bc88-69b4cc94a4b2/?download=1
          - button "Copy" [ref=e39] [cursor=pointer]
        - generic [ref=e40]: "{ \"_name\": \"seed-1383248844\", \"deceased\": { \"identityNumber\": \"1383248844\", \"identityType\": 1, \"firstName\": \"عائشة\", \"middleName\": \"أحمد\", \"lastName\": \"عبدالله\", \"familyName\": \"البقمي\", \"fullName\": \"عائشة أحمد عبدالله البقمي\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1953-10-24T00:00:00\", \"birthDateHijri\": \"1373/02/16\", \"deathDate\": \"2025-11-26T00:00:00\", \"deathDateHijri\": \"1447/06/05\", \"deathDocumentIssueDate\": null, \"deathDocumentIssueDateHijri\": \"\" }, \"beneficiary\": { \"identityNumber\": \"1652276595\", \"identityType\": 1, \"firstName\": \"عائشة\", \"middleName\": null, \"lastName\": null, \"familyName\": \"البقمي\", \"fullName\": \"عائشة البقمي\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1990-01-01T00:00:00\", \"birthDateHijri\": \"1410/06/04\", \"phoneNumber\": \"0556205567\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"beneficiaryTypeId\": 1, \"agencyTypeId\": null }, \"heirs\": [ { \"id\": \"411ec46e-129f-48ba-9e6a-efa211ecc656\", \"identityNumber\": \"1144365332\", \"identityType\": 1, \"firstName\": \"محمد\", \"middleName\": null, \"lastName\": null, \"familyName\": \"البقمي\", \"fullName\": \"محمد البقمي\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"1992-05-04T00:00:00\", \"birthDateHijri\": \"1412/11/02\", \"phoneNumber\": \"0527227475\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"isMinor\": false, \"isAdult\": true, \"isDead\": false, \"isWifePregnant\": null } ], \"request\": { \"id\": 2646, \"requestNumber\": \"SEED-89c7264c\" }, \"estateAssets\": { \"bankAccounts\": [ { \"iban\": \"SA3604606839631244992661\", \"accountNumber\": \"ACC25393560\", \"balance\": \"200000.00\" } ], \"investments\": [ { \"accountNumber\": \"ACC28703931\", \"balance\": \"200000.00\" } ] } }"
      - generic [ref=e41]:
