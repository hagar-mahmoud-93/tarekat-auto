...
- generic [ref=e1]:
  ...
  - generic [ref=e2]:
    ...
    - list [ref=e8]:
      - listitem [ref=e9]: "Inheritance case seeded successfully. Inheritance ID: ff9c8145-9d04-43e2-aed1-8972e7f9f802 | Heirs: 2 | Auth User IDs: [5029, 5030] | Assets: 2"
    - generic [ref=e10]:
      - listitem [ref=e12]: "Inheritance case seeded successfully. Inheritance ID: ff9c8145-9d04-43e2-aed1-8972e7f9f802 | Heirs: 2 | Auth User IDs: [5029, 5030] | Assets: 2"
      - generic [ref=e13]:
        ...
        - table [ref=e15]:
          ...
          - rowgroup [ref=e22]:
            - row "عمر الدوسري 1880720964 5029 Login as User" [ref=e23]:
              - cell "عمر الدوسري" [ref=e24]
              - cell "1880720964" [ref=e25]
              - cell "5029" [ref=e26]
              - cell "Login as User" [ref=e27]:
                - link "Login as User" [active] [ref=e28] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/5029/
            - row "سارة الدوسري 1794571157 5030 Login as User" [ref=e29]:
              - cell "سارة الدوسري" [ref=e30]
              - cell "1794571157" [ref=e31]
              - cell "5030" [ref=e32]
              - cell "Login as User" [ref=e33]:
                - link "Login as User" [ref=e34] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/5030/
      - generic [ref=e35]:
        - generic [ref=e36]:
          - strong [ref=e37]: Extract Case as JSON
          - link "⇩ Download JSON" [ref=e38] [cursor=pointer]:
            - /url: /admin/inheritance_seeder/inheritanceseeder/extract-json/ff9c8145-9d04-43e2-aed1-8972e7f9f802/?download=1
          - button "Copy" [ref=e39] [cursor=pointer]
        - generic [ref=e40]: "{ \"_name\": \"seed-1142219349\", \"deceased\": { \"identityNumber\": \"1142219349\", \"identityType\": 1, \"firstName\": \"خالد\", \"middleName\": \"محمد\", \"lastName\": \"عبدالعزيز\", \"familyName\": \"الدوسري\", \"fullName\": \"خالد محمد عبدالعزيز الدوسري\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"1966-07-23T00:00:00\", \"birthDateHijri\": \"1386/04/05\", \"deathDate\": \"2026-03-26T00:00:00\", \"deathDateHijri\": \"1447/10/07\", \"deathDocumentIssueDate\": null, \"deathDocumentIssueDateHijri\": \"\" }, \"beneficiary\": { \"identityNumber\": \"1880720964\", \"identityType\": 1, \"firstName\": \"عمر\", \"middleName\": null, \"lastName\": null, \"familyName\": \"الدوسري\", \"fullName\": \"عمر الدوسري\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"1990-01-01T00:00:00\", \"birthDateHijri\": \"1410/06/04\", \"phoneNumber\": \"0512160422\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"beneficiaryTypeId\": 1, \"agencyTypeId\": null }, \"heirs\": [ { \"id\": \"27d0b141-8385-43cd-a1fd-2c9eb33e6801\", \"identityNumber\": \"1794571157\", \"identityType\": 1, \"firstName\": \"سارة\", \"middleName\": null, \"lastName\": null, \"familyName\": \"الدوسري\", \"fullName\": \"سارة الدوسري\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"2002-09-01T00:00:00\", \"birthDateHijri\": \"1423/06/23\", \"phoneNumber\": \"0523552686\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"isMinor\": false, \"isAdult\": true, \"isDead\": false, \"isWifePregnant\": null } ], \"request\": { \"id\": 2644, \"requestNumber\": \"SEED-ff9c8145\" }, \"estateAssets\": { \"bankAccounts\": [ { \"iban\": \"SA6548770626311329459500\", \"accountNumber\": \"ACC51425678\", \"balance\": \"50000.00\" } ], \"investments\": [ { \"accountNumber\": \"ACC49840336\", \"balance\": \"50000.00\" } ] } }"
      - generic [ref=e41]:
