...
Locator: getByText('الأسئلة الشائعة', { exact: true }).locator('../../../..')
  Expected an image 850px by 188px, received 990px by 3315px. 91718 pixels (ratio 0.03 of all image pixels) are different.
...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 154618 pixels (ratio 0.97 of all image pixels) are different.
  - waiting 250ms before taking screenshot
  - waiting for getByText('الأسئلة الشائعة', { exact: true }).locator('../../../..')
    - locator resolved to <div data-v-9482c6f6="" mr-org-fnt-size="14px" class="bg-g-5 lg:min-h-[90vh] mr-font-size">…</div>
  - taking element screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - attempting scroll into view action
    - waiting for element to be stable
  - Expected an image 850px by 188px, received 990px by 648px. 480887 pixels (ratio 0.75 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - Expected an image 990px by 648px, received 990px by 3315px. 696339 pixels (ratio 0.22 of all image pixels) are different.
...
- generic [ref=e1]:
  ...
  - generic [ref=e2]:
    ...
    - list [ref=e8]:
      - listitem [ref=e9]: "Inheritance case seeded successfully. Inheritance ID: e2cde42d-8ba6-4937-abc9-baa9d2fa75a9 | Heirs: 2 | Auth User IDs: [4493, 4494] | Assets: 2"
    - generic [ref=e10]:
      - listitem [ref=e12]: "Inheritance case seeded successfully. Inheritance ID: e2cde42d-8ba6-4937-abc9-baa9d2fa75a9 | Heirs: 2 | Auth User IDs: [4493, 4494] | Assets: 2"
      - generic [ref=e13]:
        ...
        - table [ref=e15]:
          ...
          - rowgroup [ref=e22]:
            - row "يوسف الدوسري 1331547186 4493 Login as User" [ref=e23]:
              - cell "يوسف الدوسري" [ref=e24]
              - cell "1331547186" [ref=e25]
              - cell "4493" [ref=e26]
              - cell "Login as User" [ref=e27]:
                - link "Login as User" [active] [ref=e28] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4493/
            - row "فاطمة الدوسري 1360273994 4494 Login as User" [ref=e29]:
              - cell "فاطمة الدوسري" [ref=e30]
              - cell "1360273994" [ref=e31]
              - cell "4494" [ref=e32]
              - cell "Login as User" [ref=e33]:
                - link "Login as User" [ref=e34] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4494/
      - generic [ref=e35]:
        - generic [ref=e36]:
          - strong [ref=e37]: Extract Case as JSON
          - link "⇩ Download JSON" [ref=e38] [cursor=pointer]:
            - /url: /admin/inheritance_seeder/inheritanceseeder/extract-json/e2cde42d-8ba6-4937-abc9-baa9d2fa75a9/?download=1
          - button "Copy" [ref=e39] [cursor=pointer]
        - generic [ref=e40]: "{ \"_name\": \"seed-1288975526\", \"deceased\": { \"identityNumber\": \"1288975526\", \"identityType\": 1, \"firstName\": \"عائشة\", \"middleName\": \"محمد\", \"lastName\": \"محمد\", \"familyName\": \"الدوسري\", \"fullName\": \"عائشة محمد محمد الدوسري\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1941-12-12T00:00:00\", \"birthDateHijri\": \"1360/11/23\", \"deathDate\": \"2026-04-02T00:00:00\", \"deathDateHijri\": \"1447/10/14\", \"deathDocumentIssueDate\": null, \"deathDocumentIssueDateHijri\": \"\" }, \"beneficiary\": { \"identityNumber\": \"1331547186\", \"identityType\": 1, \"firstName\": \"يوسف\", \"middleName\": null, \"lastName\": null, \"familyName\": \"الدوسري\", \"fullName\": \"يوسف الدوسري\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"1990-01-01T00:00:00\", \"birthDateHijri\": \"1410/06/04\", \"phoneNumber\": \"0583065149\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"beneficiaryTypeId\": 1, \"agencyTypeId\": null }, \"heirs\": [ { \"id\": \"3e5509cc-3a2d-41ab-991d-3840a71c4e30\", \"identityNumber\": \"1360273994\", \"identityType\": 1, \"firstName\": \"فاطمة\", \"middleName\": null, \"lastName\": null, \"familyName\": \"الدوسري\", \"fullName\": \"فاطمة الدوسري\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1984-09-02T00:00:00\", \"birthDateHijri\": \"1404/12/07\", \"phoneNumber\": \"0517085670\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"isMinor\": false, \"isAdult\": true, \"isDead\": false, \"isWifePregnant\": null } ], \"request\": { \"id\": 2348, \"requestNumber\": \"SEED-e2cde42d\" }, \"estateAssets\": { \"bankAccounts\": [ { \"iban\": \"SA1211970637732134811185\", \"accountNumber\": \"ACC00456466\", \"balance\": \"100000.00\" } ], \"investments\": [ { \"accountNumber\": \"ACC82620636\", \"balance\": \"100000.00\" } ] } }"
      - generic [ref=e41]:
