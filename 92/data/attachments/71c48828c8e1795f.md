...
- generic [ref=e1]:
  ...
  - generic [ref=e2]:
    ...
    - list [ref=e8]:
      - listitem [ref=e9]: "Inheritance case seeded successfully. Inheritance ID: 356ed33b-aa15-40e1-92f2-564c253b007d | Heirs: 2 | Auth User IDs: [4465, 4466] | Assets: 2"
    - generic [ref=e10]:
      - listitem [ref=e12]: "Inheritance case seeded successfully. Inheritance ID: 356ed33b-aa15-40e1-92f2-564c253b007d | Heirs: 2 | Auth User IDs: [4465, 4466] | Assets: 2"
      - generic [ref=e13]:
        ...
        - table [ref=e15]:
          ...
          - rowgroup [ref=e22]:
            - row "لينا القحطاني 1714709993 4465 Login as User" [ref=e23]:
              - cell "لينا القحطاني" [ref=e24]
              - cell "1714709993" [ref=e25]
              - cell "4465" [ref=e26]
              - cell "Login as User" [ref=e27]:
                - link "Login as User" [active] [ref=e28] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4465/
            - row "نورة القحطاني 1052306921 4466 Login as User" [ref=e29]:
              - cell "نورة القحطاني" [ref=e30]
              - cell "1052306921" [ref=e31]
              - cell "4466" [ref=e32]
              - cell "Login as User" [ref=e33]:
                - link "Login as User" [ref=e34] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4466/
      - generic [ref=e35]:
        - generic [ref=e36]:
          - strong [ref=e37]: Extract Case as JSON
          - link "⇩ Download JSON" [ref=e38] [cursor=pointer]:
            - /url: /admin/inheritance_seeder/inheritanceseeder/extract-json/356ed33b-aa15-40e1-92f2-564c253b007d/?download=1
          - button "Copy" [ref=e39] [cursor=pointer]
        - generic [ref=e40]: "{ \"_name\": \"seed-1049688704\", \"deceased\": { \"identityNumber\": \"1049688704\", \"identityType\": 1, \"firstName\": \"نورة\", \"middleName\": \"خالد\", \"lastName\": \"سعد\", \"familyName\": \"القحطاني\", \"fullName\": \"نورة خالد سعد القحطاني\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1962-06-05T00:00:00\", \"birthDateHijri\": \"1382/01/03\", \"deathDate\": \"2025-10-25T00:00:00\", \"deathDateHijri\": \"1447/05/03\", \"deathDocumentIssueDate\": null, \"deathDocumentIssueDateHijri\": \"\" }, \"beneficiary\": { \"identityNumber\": \"1714709993\", \"identityType\": 1, \"firstName\": \"لينا\", \"middleName\": null, \"lastName\": null, \"familyName\": \"القحطاني\", \"fullName\": \"لينا القحطاني\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1990-01-01T00:00:00\", \"birthDateHijri\": \"1410/06/04\", \"phoneNumber\": \"0509305961\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"beneficiaryTypeId\": 1, \"agencyTypeId\": null }, \"heirs\": [ { \"id\": \"51a1813b-8365-4190-9e1b-7df761bf0f36\", \"identityNumber\": \"1052306921\", \"identityType\": 1, \"firstName\": \"نورة\", \"middleName\": null, \"lastName\": null, \"familyName\": \"القحطاني\", \"fullName\": \"نورة القحطاني\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1984-06-27T00:00:00\", \"birthDateHijri\": \"1404/09/28\", \"phoneNumber\": \"0595772828\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"isMinor\": false, \"isAdult\": true, \"isDead\": false, \"isWifePregnant\": null } ], \"request\": { \"id\": 2334, \"requestNumber\": \"SEED-356ed33b\" }, \"estateAssets\": { \"bankAccounts\": [ { \"iban\": \"SA9687641155199403202557\", \"accountNumber\": \"ACC28306410\", \"balance\": \"10000.00\" } ], \"investments\": [ { \"accountNumber\": \"ACC42513659\", \"balance\": \"25000.00\" } ] } }"
      - generic [ref=e41]:
