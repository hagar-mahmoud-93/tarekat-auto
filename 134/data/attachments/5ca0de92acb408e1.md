...
- region "المحافظ الاستثمارية":
  - button "رقم المحفظة الاستثمارية:PORT5461300850" [expanded]:
    - paragraph: رقم المحفظة الاستثمارية:PORT5461300850
  - region "رقم المحفظة الاستثمارية:PORT5461300850":
    - img
    - paragraph: البنك الأهلي السعودي
    - list:
      - listitem: وسيط التداول QA Seeder Broker
      - listitem: عدد الأسهم الكلي القابل للقسمة 500 أسهم
      - listitem: محلي نعم
      - listitem: عدد الأسهم الكلي 500 أسهم
    - table:
      - rowgroup:
      ...
      - rowgroup:
        - row "علي سعد خالد الحربي %50.00 1/2 ابن 250 أسهم":
          - cell "علي سعد خالد الحربي":
            - paragraph: علي سعد خالد الحربي
          - cell "%50.00 1/2"
          - cell "ابن"
          - cell "250 أسهم"
...
- table:
  ...
  - rowgroup:
    - row "QA Seeder Broker المحافظ 500أسهم 0أسهم":
      - cell "QA Seeder Broker"
      - cell "المحافظ"
      - cell "500أسهم"
      - cell "0أسهم"
- textbox "رقم الجوال": "0599945376"
- text: رقم الجوال
