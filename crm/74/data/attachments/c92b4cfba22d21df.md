...
- generic [ref=e1]:
  ...
  - generic [ref=e2]:
    ...
    - list [ref=e8]:
      - listitem [ref=e9]: "Inheritance case seeded successfully. Inheritance ID: c7d9486d-7c2a-4818-8ae5-d2bb004c6440 | Heirs: 2 | Auth User IDs: [4095, 4096] | Assets: 2"
    - generic [ref=e10]:
      - listitem [ref=e12]: "Inheritance case seeded successfully. Inheritance ID: c7d9486d-7c2a-4818-8ae5-d2bb004c6440 | Heirs: 2 | Auth User IDs: [4095, 4096] | Assets: 2"
      - generic [ref=e13]:
        ...
        - table [ref=e15]:
          ...
          - rowgroup [ref=e22]:
            - row "سارة الزهراني 1218598866 4095 Login as User" [ref=e23]:
              - cell "سارة الزهراني" [ref=e24]
              - cell "1218598866" [ref=e25]
              - cell "4095" [ref=e26]
              - cell "Login as User" [ref=e27]:
                - link "Login as User" [active] [ref=e28] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4095/
            - row "علي الزهراني 1694446760 4096 Login as User" [ref=e29]:
              - cell "علي الزهراني" [ref=e30]
              - cell "1694446760" [ref=e31]
              - cell "4096" [ref=e32]
              - cell "Login as User" [ref=e33]:
                - link "Login as User" [ref=e34] [cursor=pointer]:
                  - /url: /admin/inheritance_seeder/inheritanceseeder/login-as/4096/
      - generic [ref=e35]:
        - generic [ref=e36]:
          - strong [ref=e37]: Extract Case as JSON
          - link "⇩ Download JSON" [ref=e38] [cursor=pointer]:
            - /url: /admin/inheritance_seeder/inheritanceseeder/extract-json/c7d9486d-7c2a-4818-8ae5-d2bb004c6440/?download=1
          - button "Copy" [ref=e39] [cursor=pointer]
        - generic [ref=e40]: "{ \"_name\": \"seed-1533131285\", \"deceased\": { \"identityNumber\": \"1533131285\", \"identityType\": 1, \"firstName\": \"سارة\", \"middleName\": \"خالد\", \"lastName\": \"عمر\", \"familyName\": \"الزهراني\", \"fullName\": \"سارة خالد عمر الزهراني\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1961-01-30T00:00:00\", \"birthDateHijri\": \"1380/08/14\", \"deathDate\": \"2025-10-25T00:00:00\", \"deathDateHijri\": \"1447/05/03\", \"deathDocumentIssueDate\": null, \"deathDocumentIssueDateHijri\": \"\" }, \"beneficiary\": { \"identityNumber\": \"1218598866\", \"identityType\": 1, \"firstName\": \"سارة\", \"middleName\": null, \"lastName\": null, \"familyName\": \"الزهراني\", \"fullName\": \"سارة الزهراني\", \"gender\": 2, \"nationalityId\": 1, \"birthDate\": \"1990-01-01T00:00:00\", \"birthDateHijri\": \"1410/06/04\", \"phoneNumber\": \"0565297901\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"beneficiaryTypeId\": 1, \"agencyTypeId\": null }, \"heirs\": [ { \"id\": \"2f383f84-8465-41ad-a3cd-cdd16bc9f406\", \"identityNumber\": \"1694446760\", \"identityType\": 1, \"firstName\": \"علي\", \"middleName\": null, \"lastName\": null, \"familyName\": \"الزهراني\", \"fullName\": \"علي الزهراني\", \"gender\": 1, \"nationalityId\": 1, \"birthDate\": \"1989-05-15T00:00:00\", \"birthDateHijri\": \"1409/10/10\", \"phoneNumber\": \"0548859354\", \"relationshipTypeId\": 7, \"relationshipType\": \"ابن\", \"isMinor\": false, \"isAdult\": true, \"isDead\": false, \"isWifePregnant\": null } ], \"request\": { \"id\": 2149, \"requestNumber\": \"SEED-c7d9486d\" }, \"estateAssets\": { \"bankAccounts\": [ { \"iban\": \"SA7617334325312982842342\", \"accountNumber\": \"ACC91984951\", \"balance\": \"10000.00\" } ], \"investments\": [ { \"accountNumber\": \"ACC93341239\", \"balance\": \"100000.00\" } ] } }"
      - generic [ref=e41]:
